...
<div class="container mt-4">
    <div class="form-container">
        <h1 class="text-center" style="font-size: 23px; font-weight: bolder;">Customer</h1>

        <form action="{{ route('Dashboard.admin.customer.update',$customer->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="descripation" class="form-control textarea-large" required>{{ old('descripation',$customer->descripation) }}</textarea>
                    @error('descripation')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-3 text-center">
                    ...
                    @if($customer->img)
                        <img src="{{ asset($customer->img) }}" class="img-preview">
                    @else
