...
<div class="container-fluid mt-4 table-container">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <h1 style="font-size: 23px; font-weight: bolder;">SEO</h1>

        <div class="search-container">
            <input type="text" class="search-input" placeholder="Search seo...">
            <a href="{{ url('seo_opt/add') }}" class="add-new-btn">Add New </a>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a href="{{ route('Dashboard.admin.seo_opt.edit', $item->id) }}"><i class="fas fa-edit" title="Edit"></i></a>
                        <form action="{{ route('Dashboard.admin.seo_opt.delete', $item->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
