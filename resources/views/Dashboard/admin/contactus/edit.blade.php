    ...
    @method('PUT')
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control rounded-0 uniform-width" name="name" value="{{ $contact->name }}" required />
                @error('name')
             ...
             <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control rounded-0 uniform-width" name="email" value="{{ $contact->email }}" required />
                    @error('email')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="role_name" class="form-label">Message</label>
                <textarea class="form-control rounded-0 uniform-width" name="message" rows="4" required>{{ $contact->message }}</textarea>
