        ...
        <form action="{{ route('Dashboard.admin.app_development.update', $appdevelopment->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="title" value="{{ old('title',$appdevelopment->title) }}" required />
                    @error('title')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="descripation" class="form-control textarea-large" required>{{ old('descripation', $appdevelopment->descripation) }}</textarea>
                    @error('descripation')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-3 text-center">
                    ...
                    @if($appdevelopment->img)
                        <img src="{{ asset($appdevelopment->img) }}" class="img-preview">
                    @else
