            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a href="{{ route('Dashboard.admin.travel.edit', $item->id) }}"><i class="fas fa-edit" title="Edit"></i></a>
                        <form action="{{ route('Dashboard.admin.travel.delete', $item->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
