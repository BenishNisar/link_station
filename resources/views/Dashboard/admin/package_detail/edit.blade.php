...
<div class="container mt-4">
    <div class="form-container">
        ...
        @endif
        <form action="{{ route('Dashboard.admin.package_detail.update', $packaging_details->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="title" value="{{ old('title', $packaging_details->title) }}" required />
                    @error('title')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="descripation" class="form-control textarea-large" required>{{ old('descripation', $packaging_details->descripation) }}</textarea>
                    @error('descripation')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-3 text-center">
                    ...
                    @if($packaging_details->img)
                        <img src="{{ asset($packaging_details->img) }}" class="img-preview">
                    @else
